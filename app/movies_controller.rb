...
def can_be_found_updated_and_saved
  ...
  lala = Movie.where(title: "Awesome Flick")[0]
  lala.title = "Even Awesomer Flick"
  lala.save
end
...
def can_update_using_update_method
  ...
  lala = Movie.where(title: "Wat?")[0]
  Movie.update(lala.id, title:"Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  lala = Movie.where(title: "That One Where the Guy Kicks Another Guy Once")[0]
  lala.destroy
end
