...
def can_be_created_with_a_hash_of_attributes
  ...
  attributes = {
   ...
   Movie.create(title: attributes[:title], release_date: attributes[:release_date], director: attributes[:director], lead: attributes[:lead],in_theaters: attributes[:in_theaters])
...
def can_be_found_updated_and_saved
  ...
  user = Movie.create(title: "Awesome Flick")
...
def can_destroy_a_single_item
  ...
  Movie.all.find_by(title: "That One Where the Guy Kicks Another Guy Once").delete
end
